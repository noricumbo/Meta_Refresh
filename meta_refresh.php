...
$title = __('Meta Refresh Settings');
...
function meta_refresh_menu() {
	global $title;
	add_options_page( $title, 'Meta Refresh', 'manage_options', 'meta-refresh.php', 'meta_refresh_settings');
}
...
?>
	...
	<tr valign="top">
	<th scope="row"><label for="weekdays"><?php _e('Monday to Friday') ?></label></th>
	<td><input name="meta_refresh_weekdays" type="text" id="meta_refresh_weekdays" value="<?php form_option('meta_refresh_weekdays'); ?>" class="regular-text ltr" /></td>
	</tr>

	<tr valign="top">
	<th scope="row"><label for="weekends"><?php _e('Weekend') ?></label></th>
	<td><input name="meta_refresh_weekend" type="text" id="meta_refresh_weekend" value="<?php form_option('meta_refresh_weekend'); ?>" class="regular-text ltr" /></td>
	</tr>
